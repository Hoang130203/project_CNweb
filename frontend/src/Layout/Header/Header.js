  ...
  return (
    <div className={cx('header')}>
      ...
      <div className={cx('group1')} style={{ position: 'relative' }}>
        ...
        <Link to='/' className={cx('logo')} style={{ fontFamily:'Itim', color: '#000000', marginRight: '24px', position: 'absolute', top: '50%', transform: 'translateY(-50%)', left: '45px' }}>w15store</Link>      </div>
