    ...
    return (
        <div className={cx('commentBox')}>
            <div className={cx('column1')}>
                <img className={cx('accImg')} src = 'https://s3-alpha-sig.figma.com/img/0e69/55b5/ac6bae2245e3befa7985f1a3d42889b3?Expires=1714348800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=a53ArzCCmnybP0ZdfwRV0M3pBSXSE3kFrjRKaK1HamAz6hv5hie5F7aBRMhsEejpw2xCwE7kFKt9Ruvuf7H2D1zF6hn5LhkvcXlkV-f-uBzXYgIWrlj9vwyTkaNc9LN~G2Y5RxYHXfmB5RoWHwWwVofBJotF9tDEK55gwRyOOaWz3qhXHvSBfor3PMGvGatCO2a4w0Ez5X6fAfGATD8AqdJVuMggYpv7F1DEQCnQSh3wFiDOWT6QCIA0PpJ1XuLFqMmsE2XbPBS3H3MC3mmmV5jpuNvYQWm9Kq90HvoQMN-Y70U4RQrW0IPM4ceDt1z7Hcva6LO9UXfAw4zauP5jQw__' />
            </div>
            <div className={cx('column2')}>
                ...
                <div className={cx('row4')}>
                    <img className={cx('commentImg')} src='https://cdn2.cellphones.com.vn/insecure/rs:fill:358:358/q:90/plain/https://cellphones.com.vn/media/catalog/product/l/a/laptop-asus-vivobook-s-14-flip-tp3402va-lz025w-thumbnails.png'/>
                    <img className={cx('commentImg')} src='https://cdn2.cellphones.com.vn/insecure/rs:fill:358:358/q:90/plain/https://cellphones.com.vn/media/catalog/product/l/a/laptop-asus-vivobook-s-14-flip-tp3402va-lz025w-thumbnails.png'/>
                </div>
            </div>
        </div>
        ...
        <div className={cx('productRating')}>
            ...
            <div className={cx('productQuality')}>
                ...
                <p className={cx('qualityStar')}>
                    ...
                    {[...Array(Math.floor(5 - star))].map((_, index) => (
                        <div key={index} style={{ display: "inline-block" }}>
                            <IoIosStarOutline onClick={() => handleStar(index + star)} style={{ color: "#FFCB45", fontSize: "20px" }} />
            ...
            <div>
                <div>
                    ...
                    <p>
                        {[...Array(Math.floor(5))].map((_, index) => (
                            <div key={index} style={{ display: "inline-block" }}>
                                <IoIosStarOutline style={{ color: "#FFCB45", fontSize: "24px" }} />
                                <IoIosStar style={{ color: "#FFCB45", fontSize: "24px", position: "absolute", zIndex: "-1" }} />
                            </div>
                        ))}
                    </p>
                </div>
